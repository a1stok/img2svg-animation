...
- **[Future Improvements](../../../docs/future-improvements/index.md):** Planned enhancements beyond the current milestones (color SVG, vtracer, etc.). Not needed for current work, read only if explicitly relevant to the task.
